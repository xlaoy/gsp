 ...
 */
public class SettleConfigUpd extends BaseObject implements java.io.Serializable {
	/**  
	 * @Fields serialVersionUID  
	 */  
	private static final long serialVersionUID = -1457859051853019751L;

	private static final GewaLogger logger = WebLogger.getLogger(SettleConfigUpd.class);
