...
public class DramaOrderOffLineItem extends BaseObject {
	...
	public DramaOrderOffLineItem() {
	}
	
	public DramaOrderOffLineItem(Long recordid, String tradeno, Long placeid, Long quantity, Double totalfee, Double disfee,Timestamp playtime, 
